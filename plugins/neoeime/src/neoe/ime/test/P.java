...
public class P {
    ...
    private void run() {
        ...
        f.getContentPane().setLayout(
                new BoxLayout(f.getContentPane(), BoxLayout.PAGE_AXIS));
        ...
        p.addKeyListener(new KeyListener() {
            ...
            public void keyTyped(KeyEvent e) {
                ...
                if (c == 8) {
                    ...
                    jta.dispatchEvent(new 
                            KeyEvent(jta,KeyEvent.KEY_TYPED,0,0,KeyEvent.VK_UNDEFINED,c));
                }
                String v = a.out10();
